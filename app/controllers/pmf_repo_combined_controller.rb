class PmfRepoCombinedController < ApplicationController
  ...
  def load_and_combine_states
    # load internal org states
    internal_result = PmfRepo.states(@start_date, @end_date, @window, @threshold, @dependency_threshold)
    internal_result
...
#     result
  ...
  def load_and_combine_transitions
    # load internal org states
    internal_result = PmfRepo.transitions_with_details(@start_date, @end_date, @window, @threshold, @dependency_threshold)
    internal_result
#     # load filecoin states
